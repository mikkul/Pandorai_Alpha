...
{
	public class CastFireball : Effect
	{
		public int Damage;
		public int Pierce;
		public int Range;
		public ForceType Force = ForceType.Fire;
		...
		public override void Use(Creature user)
		{
			...
			UseHandler = (TileInfo tile) =>
			{
				...
				var fireballPS = new PSFireball(user.Position, 35, user.game.smokeParticleTexture, time, velocity, 40, 30, Color.Orange, true, user.game);
				...
				damageTimer.Elapsed += (s, a) =>
				{
					...
					if (tryCreature != null)
					{
						if (pierceLeft > 0)
						{
							float actualDamage = Damage - Damage * (float)tryCreature.Stats.FireResistance / 100f;
